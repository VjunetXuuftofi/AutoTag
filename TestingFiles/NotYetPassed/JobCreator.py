...
System for testing machine learning tools for tagging #JobCreator.
"""
import csv
import pickle
...
pvectorizer = pickle.load(open(
    "/Users/thomaswoodside/PycharmProjects/AutoTag/DataFiles/Vectorizers/JCVectorizer",
    "rb"))
pselector = pickle.load(open(
    "/Users/thomaswoodside/PycharmProjects/AutoTag/DataFiles/Selectors/JCSelector",
    "rb"))
